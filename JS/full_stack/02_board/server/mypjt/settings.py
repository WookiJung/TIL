...
INSTALLED_APPS = [
    ...
    # 3rd party apps
    'rest_framework',
    'rest_framework.authtoken', # 하단 REST_Framework의 token인증방식을 사용하기위해서 추가한 것.
    'rest_auth',
    'allauth',
    'allauth.account',
    # django cors
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # installed_apps에서 rest-auth.authtoken이 필요함.
    ]
}
